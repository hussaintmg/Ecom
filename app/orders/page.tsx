                  ...
                  <div className="flex-1 flex items-center gap-4 overflow-x-auto pb-2 custom-scrollbar">
                    {o.items?.map((item: any, idx: number) => (
                      ...
                      >
                        ...
                        <div className="absolute bottom-0 w-full rounded-[0px_0px_24px_24px] bg-black/60 backdrop-blur-sm text-[10px] text-white p-1 text-center font-black">
                          ×{item.quantity}
                        </div>
                      </div>
                    ))}
                      ...
                      {["pending", "processing"].includes(o.status) && (
                        <Button 
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                                const res = await fetch(`/api/orders/${o._id}/cancel`, { method: 'POST' });
                                if(res.ok) {
